...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="/backend/orders" class="brand-link">
        ...
        <div class="sidebar">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                    <a href="/backend/categoryIndex" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>類別設定</p>
                    </a>
                    </li>
                    <li class="nav-item">
                    <a href="/backend/brandIndex" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>品牌設定</p>
                    </a>
                    </li>
                ...
                <li class="nav-item">
                <a href="/backend/ocardindex" class="nav-link active">
                    <i class="nav-icon fas fa-th"></i>
                    <p>
                    OCARD
                    <span class="right badge badge-danger">測試</span>
                    </p>
                </a>
                </li>
            </ul>
