...
<section class="news-section02">
    <div class="container">
        <div class="news-item">
            <p>2021.04.01</p>
            <h4>IMONO KITCHEN 下午茶日期變更及新菜單通知</h4>
            <div class="img-wrap">
                <div class="img-item">
                    <img src="/nousaku_html/images/new/img01.jpg" alt="">
                </div>
            </div>
            <p>
                下午茶只在工作日舉行，週日每月舉行一次，由於其受歡迎程度，從8月1日起每天都會舉行。<br><br>可以用能作的鐵皮碗一點一點地享用甜點和便餐的下午茶，常用於僅限女孩的聚會和家庭出遊。<br><br>
                請在來之前預約。
            </p>
            <h4>IMONO KITCHEN 下午茶日期變更及新菜單通知</h4>
            <div class="img-wrap">
...
<section class="news-section03">
    <div class="news-list-item">
        <ul class="news-list show-more-item6">
            <li>
                <a class="flex" href="">
                    <span>2021.04.01</span>
                    <p class="over-text">Nousaku 為情侶生產旅行產品“ 為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品為情侶生產旅行產品</p>
                </a>
            </li>
            <li>
                <a class="flex over-text" href="">
                    <span>2021.04.01</span>
                    <p class="over-text">Nousaku 為情侶生產旅行產品“ Omoi Journey”續簽通知</p>
                </a>
            </li>
            <li>
                <a class="flex over-text" href="">
